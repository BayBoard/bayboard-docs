...
A job whose RO # is still PENDING cannot be marked Completed from any control.

**"Add the RO number before marking this job Completed."**

Type a numeric RO # in the job editor first, then set Completed from the status pill, Job Details, or the editor.

## Related

- [Job types](/getting-started/job-types)

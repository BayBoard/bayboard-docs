---
title: Job statuses
description: The six job statuses and how you change them.
---
...
| --- | --- | --- |
| In Queue | Queued | Not on the board. Waits in the Unassigned Jobs panel. |
| Assigned | Assigned | On a technician's column at a chosen start time. |
| In Progress | Working | Work has started. |
| Waiting on Parts | Parts | Parts are ordered. Can sit on the board or in Unassigned. |
| Completed | Completed | Work is finished. The card hatches and fades, and you cannot drag it. |

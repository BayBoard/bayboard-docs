---
title: Job statuses
description: The six job statuses, what each means, and how to change them.
---
...
| Completed | Completed | Work is finished. The card hatches and fades and cannot be dragged. |
